                      ...
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.tags.map(tag => (
                              <span key={tag} className="px-3 py-1 bg-indigo-100 text-black rounded-full text-sm">
                        {tag}
                      </span>
                          ))}
                        </div>
                ...
                {projects.filter(project => !project.featured).map(project => (
                    <div key={project.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-gray-900 mb-3 text-sm line-clamp-2">{project.description}</p>
                        <div className="flex flex-wrap gap-1 mb-3">
                          {project.tags.slice(0, 3).map(tag => (
                              <span key={tag} className="px-2 py-1 bg-indigo-100  rounded-full text-xs">
                        {tag}
                      </span>
                          ))}
                        ...
                        <div className="flex space-x-2">
                          <a
                              href={project.demoLink}
                              className="px-3 py-1 bg-black text-white rounded-md text-sm hover:bg-black-900 transition-colors"
                              target="_blank"
                              rel="noopener noreferrer"
                          >
                            Demo
                          ...
                          <a
                              href={project.codeLink}
                              className="px-3 py-1 border border-gray-300 text-gray-900 text-sm rounded-md hover:bg-gray-100 transition-colors"
                              target="_blank"
                              rel="noopener noreferrer"
                          >
                            Code
