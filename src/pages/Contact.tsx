            ...
            <AnimatedSection animation="slideLeft" delay={200}>
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <form>
                  ...
                  <button
                      type="submit"
                      className="w-full bg-black  text-white py-3 px-4 rounded-md hover:bg-gray-900 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Send Message
                  </button>
                </form>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">naphtalimorage56@gmail.com</p>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">+254 716-220-216</p>
              ...
              <AnimatedSection animation="slideRight" delay={400}>
                <div className="bg-white p-8 rounded-lg shadow-md">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <a
                        href="https://github.com/naphtalimorage"
                        target="_blank"
                    ...
                    <a
                        href="https://linkedin.com/in/naphtalimorage/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
                    >
                    ...
                    <a
                        href="https://twitter.com/naphtalimorage"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
                    >
                    ...
                    <a
                        href="https://instagram.com/moragenaphtali"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
                    >
