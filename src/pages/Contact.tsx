      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-6 text-blue-700">Send Me a Message</h2>
            <form>
              <div className="mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a 
                  ...
                  className="flex items-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
                >
                  <svg className="h-6 w-6 mr-3 text-blue-700" fill="currentColor" viewBox="0 0 24 24">
